...
import {styles} from "./editoriaisFotograficosStyle";
...
export default function EditoriaisFotograficos() {
                    ...
                    <Grid container justify="space-evenly" spacing={10}>
                        {CategoriasArq.map((categoria) => (
                            <Grid key={categoria.id} item>
                                <CardComponent categoria={categoria} rota="/editoriais/editorial"/>
                            </Grid>
                        ))}
                    </Grid>
                </Grid>
